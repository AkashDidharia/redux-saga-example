...
class App extends Component {
  render() {
    const { productfetching, cartfetching, userfetching, products, user, cart, token, onRequestProducts,onRequestCart,onRequestUser,onRequestToken, error } = this.props;
...
{/* 
            <td>
            <header className="App-header">
            <h1 className="App-title">Token:</h1>
              {token || "empty token"}
            </header>
            </td> */}
            </tr>
        ...
        {/* {fetching ? (
            ...
            <button onClick={onRequestToken}>Request Token</button>
        )} */}
