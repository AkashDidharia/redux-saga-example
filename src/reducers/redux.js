...
//cart action types
import API_CALL_REQUEST_TOKEN from "../actions/tokenActions/apiCallRequestToken";
import API_CALL_RECIEVE_TOKEN from "../actions/tokenActions/apiCallRecieveToken";
//call failure action
...
export function reducer(state=initialState, action) {
    switch(action.type) {
        ...
        // case API_CALL_REQUEST_TOKEN:
        //     return {...state, tokenfetching:true, error: null };
        // case API_CALL_RECIEVE_TOKEN:
        //     return {...state, tokenfetching:false, token: action.token };
